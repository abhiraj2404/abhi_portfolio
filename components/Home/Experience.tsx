...
const experienceData = [
  {
    ...
    logo: "/okto.jpeg",
    url: "https://okto.tech/",
    skills: ["NextJs", "Typescript", "React", "Web3", "ElizaOS", "React Native"]
  },
  {
  ...
  },
  {
    ...
    logo: "/gdg.png",
    url: "https://www.linkedin.com/company/gdg-iiits",
            ...
            <div key={index} className="relative flex flex-col sm:flex-row items-start gap-4 sm:gap-6 group">
              <div className="flex sm:flex-col items-center">
                <Link href={experience.url} target="_blank">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center rounded-full bg-zinc-800 border border-zinc-600 group-hover:border-zinc-400 transition-colors">
                    <Image src={experience.logo} alt={experience.company} width={48} height={48} className="rounded-sm" />
                  </div>
                </Link>
              ...
              <div className="flex-1 space-y-2">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                  <h4 className="text-lg sm:text-xl font-semibold text-zinc-100">{experience.title}</h4>
                  <span className="text-sm text-zinc-400 shrink-0">{experience.period}</span>
                </div>

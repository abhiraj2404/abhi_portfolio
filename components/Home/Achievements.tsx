...
const achievementsData = [
  ...
  },
  {
    ...
    event: "GDSC IIIT Sri City",
    type: "Core Member",
    date: "Sept 2024 - Present",
    description: "Leading backend development initiatives and organizing tech events",
    skills: ["Leadership", "Backend Development", "Event Management"]
  },
  {
    ...
    date: "2023 - Present",
    description: "Contributing to various open source projects and maintaining repositories",
    skills: ["Git", "Open Source", "Community Building"]
  },
  {
    ...
    type: "Top 10%",
    date: "December 2023",
    description: "Achieved top 10% ranking in competitive programming contest",
            ...
            <div key={index} className="relative flex flex-col sm:flex-row items-start gap-4 sm:gap-6 group">
              ...
              <div className="flex-1 space-y-2">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                  <h4 className="text-lg sm:text-xl font-semibold text-zinc-100">{achievement.title}</h4>
                  <span className="text-sm text-zinc-400 shrink-0">{achievement.date}</span>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {achievement.skills.map((skill, i) => (
                    <span key={i} className="px-3 py-1 text-xs text-zinc-300 bg-zinc-800/50 rounded-full">
                      {skill}
                    </span>
                  ))}
                </div>
